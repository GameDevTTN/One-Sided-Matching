...
public class ThreeStealsPerItem extends DeterministicAlgorithm {

    @Override
    public String getName() {
        return "Yankee Swap 3S/I";
    }
    ...
    protected int[] solve(Permutation priority, PreferenceProfile input, int agents, int objects) {
        ...
        int[] itemStealCount = new int[agents];
        ...
        while (pp.hasNext()) {
            ...
            while (true) {
                ...
                while (alreadyStolen[actingAgent - 1][desiredItem - 1] || (itemStealCount[desiredItem - 1] >= stealsPerRound() && obj[desiredItem - 1] != 0)) {
                ...
                if (temp > 0) { //someone has it
                    ...
                    ++itemStealCount[desiredItem - 1]; //count that as a steal
                } else {
